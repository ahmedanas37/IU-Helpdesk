...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO attachments (comment_id,file_name,file_path,created_at) VALUES (?,?,?,?)");

        if($stmt->execute([ $comment_id,$file_name,$file_path,$created_at  ])) {
                $stmt = null;
                header("location: attachments-index.php");
            } else{
