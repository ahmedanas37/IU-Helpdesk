...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO ticket (title,ticket_description,date_added,date_updated,user_id,department_id,comments,ticket_status) VALUES (?,?,?,?,?,?,?,?)");

        if($stmt->execute([ $title,$ticket_description,$date_added,$date_updated,$user_id,$department_id,$comments,$ticket_status  ])) {
                $stmt = null;
