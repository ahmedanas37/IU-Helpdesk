...
<div class="dx-feature dx-feature-3 dx-feature-color-4 dx-block-decorated">
    ...
    <div class="dx-feature-cont">
        <div class="dx-feature-title"><a href="ticket.php">Ticket System</a></div>
        <div class="dx-feature-text">Submit and track requests for efficient issue resolution.</div>
        <a href="ticket.php" class="dx-btn dx-btn-link d-flex dx-feature-link">Read More <span class="icon pe-7s-angle-right"></span></a>
    </div>
</div>
