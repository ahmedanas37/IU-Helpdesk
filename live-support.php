...
<div class="dx-box-5 pb-100 bg-grey-6">
    ...
    <div class="chatbox">
        <div class="chatbox-header">
            <h2 class="chatbox-title">Live Support</h2>
        </div>
        <div class="chatbox-select">
...
<script>
    ...
    // Function to load the list of recipients from the database
    ...
    // Function to load chat messages with a selected recipient
    ...
    // Poll for new messages every 3 seconds (adjust the interval as needed)
    setInterval(pollForNewMessages, 2500); 
});
